package com.puchoInc.diya.DataBase;
...
import com.puchoInc.diya.OnDatabaseChangedListener;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static abstract class DBHelperItem implements BaseColumns {
        ...
        public static final String COLUMN_NAME_URL_ADDED = "url_added";
    }
...
//                    DBHelperItem.COLUMN_NAME_RECORDING_FILE_PATH + TEXT_TYPE + COMMA_SEP +
//                    DBHelperItem.COLUMN_NAME_RECORDING_LENGTH + " INTEGER " + COMMA_SEP +
//                    DBHelperItem.COLUMN_NAME_TIME_ADDED + " INTEGER " +COMMA_SEP+DBHelperItem.COLUMN_NAME_URL_ADDED+TEXT_TYPE+ ")";
...
//    }
    ...
    public RecordingItem getItemAt(int position) {
        ...
        String[] projection = {
               ...
               // DBHelperItem.COLUMN_NAME_URL_ADDED
        };
        ...
        if (c.moveToPosition(position)) {
           ...
           // item.seturl(c.getString(c.getColumnIndex(DBHelperItem.COLUMN_NAME_URL_ADDED)));
            c.close();
            return item;
        }
        return null;
    ...
    public long addRecording(String recordingName, String filePath, long length) {
     ...
     //   cv.put(DBHelperItem.COLUMN_NAME_URL_ADDED,url);
    ...
    public long restoreRecording(RecordingItem item) {
       ...
       // cv.put(DBHelperItem.COLUMN_NAME_URL_ADDED,item.geturl());
        long rowId = db.insert(DBHelperItem.TABLE_NAME, null, cv);
        if (mOnDatabaseChangedListener != null) {
            //mOnDatabaseChangedListener.onNewDatabaseEntryAdded();
        }
